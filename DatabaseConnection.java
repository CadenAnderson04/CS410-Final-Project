 ...
 * It contains a single static method, makeConnection, which returns a Connection 
 * object that can be used to interact with the database. 
 * The method handles any SQLExceptions that may occur during the connection process 
